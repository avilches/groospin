...
class MameMapping {
    ...
    MameMapping backupAndCleanDefaultCfg() {
        println "- MAME: Backup (if exists) and clean default.cfg:"
        println cfg.absolutePath
        loadDefaultCfg()
        if (mapping) {
...
//                println
    ...
    static String KEY_0_PAD = "KEYCODE_0PAD"
    static String KEY_1_PAD = "KEYCODE_1PAD"
    static String KEY_2_PAD = "KEYCODE_2PAD"
    static String KEY_3_PAD = "KEYCODE_3PAD"
    static String KEY_4_PAD = "KEYCODE_4PAD"
    static String KEY_5_PAD = "KEYCODE_5PAD"
    static String KEY_6_PAD = "KEYCODE_6PAD"
    static String KEY_7_PAD = "KEYCODE_7PAD"
    static String KEY_8_PAD = "KEYCODE_8PAD"
    static String KEY_9_PAD = "KEYCODE_9PAD"
    static String DECIMAL_PAD = "KEYCODE_DELPAD"
    static String MINUS_PAD = "KEYCODE_MINUSPAD"
    static String PLUS_PAD = "KEYCODE_PLUSPAD"
    static String SLASH_PAD = "KEYCODE_SLASHPAD"
