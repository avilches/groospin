...
def commonFilter = { MameMachine rom ->
    true
}
// MAME
DatXmlToHyperSpinXml.store(roms,
        ...
        header + [listname: "MAME only working"]) { MameMachine rom ->
            return commonFilter(rom) && rom.working
}
Comparer.printDifferences(
        "${databaseRoot}/MAME/MAME.xml",
        "c:/Users/Alberto/Downloads/mame0.171/Mame/Working Games/Mame.xml")
Comparer.printDifferences("MAME", databaseRoot, "k:/Games/HyperSpin-fe/Databases")
...
DatXmlToHyperSpinXml.store(roms,
    ...
    commonFilter(rom) && rom.working && rom.players >= 3
}
Comparer.printDifferences("MAME 4 Players", databaseRoot, "k:/Games/HyperSpin-fe/Databases")
...
DatXmlToHyperSpinXml.store(roms,
    ...
    commonFilter(rom) && rom.working && rom.manufacturer.contains("SNK") && rom.romof != "neogeo" && rom.romof != "hng64"
}
Comparer.printDifferences("SNK Classics", databaseRoot, "k:/Games/HyperSpin-fe/Databases")

DatXmlToHyperSpinXml.store(roms,
        "${databaseRoot}/Nintendo Classics/Nintendo Classics.xml",
        header + [listname: "Nintendo Classics"]) { MameMachine rom ->
    commonFilter(rom) && rom.working && (rom.manufacturer.contains("Nintendo") || rom.sourcefile == "vsnes.cpp")
}
Comparer.printDifferences("Nintendo Classics", databaseRoot, "k:/Games/HyperSpin-fe/Databases")
...
DatXmlToHyperSpinXml.store(roms,
    ...
    commonFilter(rom) && rom.romof == "neogeo"
}
Comparer.printDifferences("SNK Neo Geo AES", databaseRoot, "k:/Games/HyperSpin-fe/Databases")
...
DatXmlToHyperSpinXml.store(roms,
    ...
    commonFilter(rom) && rom.romof == "hng64"
}
Comparer.printDifferences("HyperNeoGeo64", databaseRoot, "k:/Games/HyperSpin-fe/Databases")

DatXmlToHyperSpinXml.store(roms,
        "${databaseRoot}/Capcom Play System/Capcom Play System.xml",
        header + [listname: "Capcom Play System"]) { MameMachine rom ->
    commonFilter(rom) && rom.working && rom.sourcefile == "cps1.cpp"
}
Comparer.printDifferences("Capcom Play System", databaseRoot, "k:/Games/HyperSpin-fe/Databases")


DatXmlToHyperSpinXml.store(roms,
        "${databaseRoot}/Capcom Play System II/Capcom Play System II.xml",
        header + [listname: "Capcom Play System II"]) { MameMachine rom ->
    commonFilter(rom) && rom.working && rom.sourcefile == "cps2.cpp"
}
Comparer.printDifferences("Capcom Play System II", databaseRoot, "k:/Games/HyperSpin-fe/Databases")

DatXmlToHyperSpinXml.store(roms,
        "${databaseRoot}/Capcom Play System III/Capcom Play System III.xml",
        header + [listname: "Capcom Play System III"]) { MameMachine rom ->
    commonFilter(rom) && rom.working && rom.sourcefile == "cps3.cpp"
}
Comparer.printDifferences("Capcom Play System III", databaseRoot, "k:/Games/HyperSpin-fe/Databases")

DatXmlToHyperSpinXml.store(roms,
        "${databaseRoot}/Sega ST-V/Sega ST-V.xml",
        header + [listname: "Sega ST-V"]) { MameMachine rom ->
    commonFilter(rom) && rom.romof == "stvbios"
}
Comparer.printDifferences("Sega ST-V", databaseRoot, "k:/Games/HyperSpin-fe/Databases")

DatXmlToHyperSpinXml.store(roms,
        "${databaseRoot}/Namco System 22/Namco System 22.xml",
        header + [listname: "Namco System 22"]) { MameMachine rom ->
    commonFilter(rom) && rom.working && rom.sourcefile == "namcos22.cpp"
}
Comparer.printDifferences("Namco System 22", databaseRoot, "k:/Games/HyperSpin-fe/Databases")
...
["Namco Classics",
 ...
 "Sega Classics", "Konami Classics", "Taito Classics"].sort().each {
    ...
    DatXmlToHyperSpinXml.store(roms,
        ...
        commonFilter(rom) && rom.working && rom.manufacturer.contains(find)
    }

    Comparer.printDifferences(it, databaseRoot, "k:/Games/HyperSpin-fe/Databases")
}
